    ...
    <div class="page-content page-home">
        ...
        <section class="store-new-products">
            ...
            <div class="row">
                ...
                data-aos-delay="100"
                >
                <a class="component-products d-block" href="{{ route('details', ['id' => 1]) }}">
                ...
                data-aos-delay="200"
                >
                <a class="component-products d-block" href="{{ route('details', ['id' => 2]) }}">
                    <div class="products-thumbnail">
                    <div
                        class="products-image"
                        style="
                ...
                data-aos-delay="300"
                >
                <a class="component-products d-block" href="{{ route('details', ['id' => 3]) }}">
                    <div class="products-thumbnail">
                    <div
                        class="products-image"
                        style="
                ...
                data-aos-delay="400"
                >
                <a class="component-products d-block" href="{{ route('details', ['id' => 4]) }}">
                    <div class="products-thumbnail">
                    <div
                        class="products-image"
                        style="
                ...
                data-aos-delay="500"
                >
                <a class="component-products d-block" href="{{ route('details', ['id' => 5]) }}">
                    <div class="products-thumbnail">
                    <div
                        class="products-image"
                        style="
                ...
                data-aos-delay="600"
                >
                <a class="component-products d-block" href="{{ route('details', ['id' => 6]) }}">
                    <div class="products-thumbnail">
                    <div
                        class="products-image"
                        style="
                ...
                data-aos-delay="700"
                >
                <a class="component-products d-block" href="{{ route('details', ['id' => 7]) }}">
                    <div class="products-thumbnail">
                    <div
                        class="products-image"
                        style="
                ...
                data-aos-delay="800"
                >
                <a class="component-products d-block" href="{{ route('details', ['id' => 8]) }}">
                    <div class="products-thumbnail">
                    <div
                        class="products-image"
                        style="
